    ...
    angular.module('ngWYSIWYG').directive('wysiwygEdit', ['$compile', '$timeout', '$q',
        function ($compile, $timeout, $q) {
            var linker = function (scope, $element, attrs, ctrl) {
                ...
                scope.fonts = ['Verdana', 'Arial', 'Arial Black', 'Arial Narrow', 'Courier New', 'Century Gothic', 'Comic Sans MS', 'Georgia', 'Impact', 'Tahoma', 'Times', 'Times New Roman', 'Webdings', 'Trebuchet MS', 'Helvetica Neue'];
                /*
